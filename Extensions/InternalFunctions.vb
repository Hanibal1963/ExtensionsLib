...
''' <summary>
''' Definition der internen Funktionen
''' </summary>
Friend Class InternalFunctions
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalFormatted(sender As Double, precision As Integer, culture As Globalization.CultureInfo) As String
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalGetPercentageOf(value As Double, total As Double) As Double
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalFractionBy(value As Double, percent As Double) As Double
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalIsPositive(value As Double) As Boolean
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalIsNegative(value As Double) As Boolean
    ' Initialisiere das Ergebnis als False
    Dim result As Boolean = False
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalIsPrime(value As Long) As Boolean
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalIsDivisibleBy(source As Double, value As Double) As Boolean
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalIsMultipleOf(source As Double, value As Double) As Boolean
    ' Überprüft, ob der Rest der Division von "source" durch "value" gleich 0 ist.
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalIsInRangeOf(source As Double, minimum As Double, maximum As Double) As Boolean
  ...
  ''' </returns>
  <DebuggerStepThrough>
  Public Shared Function InternalDifferenceOf(source As Double, value As Double) As Double
